...
class button_licencesearch : RscButton  {idc = 12;x = 0.41; y = 0.64;w = 0.20; h = 0.04;text = "Check Licences";			action = "[8] execVM ""civmenuinit.sqf""; closedialog 0";};
...
class uninteraktion
{
	...
	class button_heal : RscButton            {idc = 13;x = 0.41; y = 0.68;w = 0.20; h = 0.04;text = "Heal this civ";					action = "[5] execVM ""civmenuinit.sqf""; closedialog 0";};
...
class button_inventarsearch : RscButton{idc = 14;x = 0.41; y = 0.33;w = 0.20; h = 0.04; text = "Check Inventory";action = "[6] execVM ""civmenuinit.sqf""; closedialog 0";};
