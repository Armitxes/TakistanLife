...
INV_Lizenzen = [
  ...
  ["car",[adminbank,atm1,adminbank],localize "STRS_license_car",100],
  ["truck",[adminbank,atm1,adminbank],localize "STRS_license_truck",1400],
  ["air",[adminbank,atm1,adminbank],localize "STRS_license_air",7500],
  ["Pistollicense",[adminbank,licenseflag2,adminbank],"Pistol License",1500],
  ["Riflelicense",[adminbank,licenseflag2,adminbank],"Rifle License",3000],
  ["automatic",[adminbank,licenseflag2,adminbank],"Automatic Rifle License",4500],
  ["engineer",[adminbank,atm1,memshop,memshop],localize "STRS_license_engineer",750],
  ...
  ["southgov",[adminbank,southshop,southshop], "South Government License",140000],
