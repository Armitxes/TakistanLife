...
RadioTrigger_2 setTriggerStatements ["this","[] execVM ""armitxes\cleaner.sqf"";",""];
2 setRadioMsg "REMOVE BIRDSLOTS";
...
RadioTrigger_5 setTriggerStatements ["this", "[""gangmember""] execVM ""gangfix.sqf"";", ""];
5 setRadioMsg "FIX GANGMEMBER";
